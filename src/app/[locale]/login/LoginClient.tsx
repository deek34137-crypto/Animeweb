      ...
      <div className="max-w-md w-full space-y-8 p-8 rounded-2xl glass-panel shadow-2xl relative overflow-hidden">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-1.5">
            <label htmlFor="login-email" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
              Email Address
            </label>
          ...
          {/* Password */}
          <div className="space-y-1.5">
            <label htmlFor="login-password" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
              Password
            </label>
            <div className="relative">
              <input
