          ...
          {submitted ? (
            ...
            <div className="glass-panel border border-border-default rounded-3xl p-6 sm:p-8 space-y-6 relative overflow-hidden">
              ...
              {error && (
                <div
                  role="alert"
                  className="flex items-center space-x-2 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl p-4 text-xs"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="contact-name" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
                      Your Name *
                    </label>
                  ...
                  {/* Email */}
                  <div className="space-y-1.5">
                    <label htmlFor="contact-email" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
                      Email Address *
                    </label>
                    <div className="relative">
                      <input
                ...
                {/* Subject */}
                <div className="space-y-1.5">
                  <label htmlFor="contact-subject" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
                    Subject *
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-surface-2 border border-border-subtle rounded-xl py-2.5 pl-10 pr-4 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition text-sm text-text-primary"
                    />
                    <MessageSquare size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-text-disabled" aria-hidden="true" />
                  </div>
                </div>

                {/* Message */}
                <div className="space-y-1.5">
                  <label htmlFor="contact-message" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
                    Message *
                  </label>
                  <textarea
                    id="contact-message"
